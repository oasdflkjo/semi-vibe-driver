...
def main():
    ...
    if sys.platform == "win32":
        ...
        dll_path = os.path.join(
            build_dir, "build", "bin", "Debug", "semi_vibe_device.dll"
        )
        ...
        lib_path = os.path.join(build_dir, "build", "lib", "libsemi_vibe_device.so")

        if not os.path.exists(lib_path):
            print(
                "Error: Shared library not found. Make sure you have built the project."
            )
            return 1
        ...
        try:
            ...
            print("Make sure you have built the shared library using CMake.")
            return 1
